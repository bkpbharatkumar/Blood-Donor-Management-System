                ...
                <div class="col-lg-7 top-social-agile">
                    <div class="row">
                        ...
                        <ul class="col-lg-4 col-6 top-right-info text-center">
                            <li>
                                <a href="https://www.facebook.com/bharatparihar.official">
                                    <i class="fab fa-facebook-f"></i>
                                </a>
                            </li>
                            <li class="mx-3">
                                <a href="https://www.instagram.com/i.m.bkp">
                                    <i class="fab fa-instagram"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.linkedin.com/in/bkp-bharat-parihar-92313024a">
                                    <i class="fab fa-linkedin-in"></i>
                                </a>
                            </li>
                            <li class="ml-3">
                                <a href="https://www.youtube.com/@BkpVerse">
...
{ ?>
                        ...
                        <div class="col-6 header-top_w3layouts pl-3 text-lg-left text-center">
                            <p class="text-white">
                                <i class="fas fa-map-marker-alt mr-2 text-white"> Indore </i>
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-7 col-6 top-w3layouts">
                            <p class="text-white">
                                ...
                                <a href="mailto:info@example.com"
                                    class="text-white">bkp@gmail.com</a>
                            </p>
                        </div>
                        <div class="col-lg-5 col-6 header-w3layouts pl-4 text-lg-left">
                            <p class="text-white">
                                <i class="fas fa-phone mr-2"></i>8817355715
                            </p>
                        </div>
                    </div><?php } } ?>
                </div>
